    ...
    <div v-if="!showLoading">
      <div class="header-pic">
        ...
        <div class="special-container">
          ...
          <img @click="goSee" v-if="env == 'ios' || env=='android' " class="advertising-space" src="../../../assets/img/advertising-space.gif" alt="">
...
export default {
  ...
  methods: {
    ...
    getCoupon(type) {
      ...
      this.$http.fetchGet(this.URL.receiveSubjectTicket, params).then(res => {
        if (res.code === 100) {
    ...
    getSubjectTicket(type) {
      ...
      this.$http.fetchGet(this.URL.getSubjectTicket, params).then(res => {
        if (res.code === 100) {
          if (type == 1) {
